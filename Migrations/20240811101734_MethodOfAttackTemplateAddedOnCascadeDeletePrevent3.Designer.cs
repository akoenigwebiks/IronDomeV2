...
namespace IronDomeV2.Migrations
{
    ...
    [Migration("20240811101734_MethodOfAttackTemplateAddedOnCascadeDeletePrevent3")]
    partial class MethodOfAttackTemplateAddedOnCascadeDeletePrevent3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IronDomeV2.Models.MethodOfAttack", b =>
                {
                    ...
                    b.Property<int>("MethodOfAttackTemplateId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MethodOfAttackTemplateId");
            ...
            modelBuilder.Entity("IronDomeV2.Models.MethodOfAttack", b =>
                {
                    b.HasOne("IronDomeV2.Models.MethodOfAttackTemplate", "MethodOfAttackTemplate")
                        .WithMany("MethodOfAttacks")
                        .HasForeignKey("MethodOfAttackTemplateId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("IronDomeV2.Models.Volley", "Volley")
                        .WithMany("MethodsOfAttacks")
                        .HasForeignKey("VolleyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MethodOfAttackTemplate");
            ...
            modelBuilder.Entity("IronDomeV2.Models.MethodOfAttackTemplate", b =>
                {
                    b.Navigation("MethodOfAttacks");
                });

            modelBuilder.Entity("IronDomeV2.Models.Volley", b =>
                {
                    b.Navigation("MethodsOfAttacks");
                });
